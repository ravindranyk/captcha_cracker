...
public  class CaptchaGenerator extends java.lang.Object implements java.io.Serializable
{
	...
	public static void generate_captcha(int image_number, char[] input, String[] background,
		...
		File outputfile = new File("/home/geetika/captcha/dataset_ssd_1T/variable_dataset_2000/" + image_number + "_" +  captcha.getAnswer() + ".jpg");
	...
	public static void main(String args[]) throws IOException, InstantiationException, IllegalAccessException, ClassNotFoundException{
		...
		for(image_number = 0; image_number  < 2000; image_number++){
